...
function DonHang() {
  ...
  const disableButton = () => {
    ...
    btnOrder.innerHTML = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Đang xử lý';
  }
          ...
          <form className="row g-3" onSubmit={handleSubmit}>
            ...
            <div className="col-12">
              <Link to="/giohang" className="btn btn-link btn-lg">
               ...
               <button id="btnOrder" className="btn btn-danger btn-lg float-end" type="submit">
                Đặt hàng
              </button>
            </div>
          </form>
